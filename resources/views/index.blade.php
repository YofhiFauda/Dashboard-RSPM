  ...
  <section class="content">
    <div class="container-fluid my-5">
      <div class="row mt-5 m-4" id="dashboard-container">
        ...
        @php
          $menus = [
            ['name' => 'Inbox', 'icon' => 'fa-envelope', 'color' => 'blue'],
            ['name' => 'Tasks', 'icon' => 'fa-tasks', 'color' => 'green'],
            ['name' => 'Reports', 'icon' => 'fa-chart-bar', 'color' => 'yellow'],
            ['name' => 'Favorites', 'icon' => 'fa-star', 'color' => 'red'],
            ['name' => 'Settings', 'icon' => 'fa-cogs', 'color' => 'blue'],
            ['name' => 'Calendar', 'icon' => 'fa-calendar-alt', 'color' => 'green'],
            ['name' => 'Messages', 'icon' => 'fa-comments', 'color' => 'yellow'],
            ['name' => 'Notifications', 'icon' => 'fa-bell', 'color' => 'red'],
            ['name' => 'Users', 'icon' => 'fa-users', 'color' => 'blue'],
            ['name' => 'Files', 'icon' => 'fa-folder-open', 'color' => 'green'],
            ['name' => 'Analytics', 'icon' => 'fa-chart-pie', 'color' => 'yellow'],
            ['name' => 'Support', 'icon' => 'fa-life-ring', 'color' => 'red'],
